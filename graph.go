...
func getActorDetails(nconst string) Actor {
	var actor Actor
...
func actorsInTitle(tconst string) []Actor {
	var actors []Actor
...
func titlesWithActor(nconst string) []Title {
...
func getTitleDetails(tconst string) Title {
	var title Title
